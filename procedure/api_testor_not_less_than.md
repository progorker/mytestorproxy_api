...
=======|__/=========================
  API References of myTestorProxy
           ----- oOo -----
[procedure] api_testor_not_less_than
====================================
...
procedure mytestorproxy.api_testor_not_less_than (
...
$) set @v_test_id = -1; set @v_suite_id = 1; set @v_case_id = 10; call mytestorproxy.api_testor_not_less_than( '8003c6c90940e847a8e01897b4a93e4d', @v_test_id, @v_suite_id, @v_case_id, 'less.1', 3, 3.5 ); select @v_test_id, @v_suite_id, @v_case_id;
...
$) set @v_test_id = -1; set @v_suite_id = 1; set @v_case_id = 10; call mytestorproxy.api_testor_not_less_than( '8003c6c90940e847a8e01897b4a93e4d', @v_test_id, @v_suite_id, @v_case_id, 'less.2', 4, 3.5 ); select @v_test_id, @v_suite_id, @v_case_id;
...
| case        | test   | message                                                          |
+-------------+--------+------------------------------------------------------------------+
| table-users | less.1 | [less.1] test (not_less_than) is failed. 
Operand: 3
Value: 3.5
 |
+-------------+--------+------------------------------------------------------------------+
...
| case        | test   | message                                                           |
+-------------+--------+-------------------------------------------------------------------+
| table-users | less.2 | [less.2] test (not_less_than) is success. 
Operand: 4
Value: 3.5
 |
+-------------+--------+-------------------------------------------------------------------+
