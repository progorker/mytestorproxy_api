...
procedure mytestorproxy.api_testor_contains (
...
$) call api_testor_clean( '8003c6c90940e847a8e01897b4a93e4d', 1 );
...
$) set @v_test_id = -1; set @v_suite_id = 1; set @v_case_id = 13; call mytestorproxy.api_testor_contains( '8003c6c90940e847a8e01897b4a93e4d', @v_test_id, @v_suite_id, @v_case_id, 'contains.1', 'Hello world!', 'world' ); select @v_test_id, @v_suite_id, @v_case_id;
...
$) set @v_test_id = -1; set @v_suite_id = 1; set @v_case_id = 13; call mytestorproxy.api_testor_contains( '8003c6c90940e847a8e01897b4a93e4d', @v_test_id, @v_suite_id, @v_case_id, 'contains.2', 'Hello world!', 'worldABC' ); select @v_test_id, @v_suite_id, @v_case_id;
...
| case        | test       | message                                                                         |
+-------------+------------+---------------------------------------------------------------------------------+
| table-users | contains.2 | [contains.2] test (contains) is failed. 
Operand: Hello world!
Value: worldABC
 |
+-------------+------------+---------------------------------------------------------------------------------+
...
| case        | test       | message                                                                       |
+-------------+------------+-------------------------------------------------------------------------------+
| table-users | contains.1 | [contains.1] test (contains) is success. 
Operand: Hello world!
Value: world
 |
+-------------+------------+-------------------------------------------------------------------------------+
