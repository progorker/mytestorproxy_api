...
procedure mytestorproxy.api_testor_not_greater_than (
...
$) set @v_test_id = -1; set @v_suite_id = 1; set @v_case_id = 8; call mytestorproxy.api_testor_not_greater_than( '8003c6c90940e847a8e01897b4a93e4d', @v_test_id, @v_suite_id, @v_case_id, 'greater.1', 3, 2.5 ); select @v_test_id, @v_suite_id, @v_case_id;
...
$) set @v_test_id = -1; set @v_suite_id = 1; set @v_case_id = 8; call mytestorproxy.api_testor_not_greater_than( '8003c6c90940e847a8e01897b4a93e4d', @v_test_id, @v_suite_id, @v_case_id, 'greater.2', 3, 3.5 ); select @v_test_id, @v_suite_id, @v_case_id;
...
| case        | test      | message                                                                |
+-------------+-----------+------------------------------------------------------------------------+
| table-users | greater.1 | [greater.1] test (not_greater_than) is failed. 
Operand: 3
Value: 2.5
 |
+-------------+-----------+------------------------------------------------------------------------+
...
| case        | test      | message                                                                 |
+-------------+-----------+-------------------------------------------------------------------------+
| table-users | greater.2 | [greater.2] test (not_greater_than) is success. 
Operand: 3
Value: 3.5
 |
+-------------+-----------+-------------------------------------------------------------------------+
