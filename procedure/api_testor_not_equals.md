...
procedure mytestorproxy.api_testor_not_equals (
...
$) set @v_test_id = -1; set @v_suite_id = 1; set @v_case_id = 6; call mytestorproxy.api_testor_not_equals( '8003c6c90940e847a8e01897b4a93e4d', @v_test_id, @v_suite_id, @v_case_id, 'equals.1', 2.5, 2.5 ); select @v_test_id, @v_suite_id, @v_case_id;
...
$) set @v_test_id = -1; set @v_suite_id = 1; set @v_case_id = 6; call mytestorproxy.api_testor_not_equals( '8003c6c90940e847a8e01897b4a93e4d', @v_test_id, @v_suite_id, @v_case_id, 'equals.2', 2.5, 3.5 ); select @v_test_id, @v_suite_id, @v_case_id;
...
| case        | test     | message                                                           |
+-------------+----------+-------------------------------------------------------------------+
| table-users | equals.1 | [equals.1] test (not_equals) is failed. 
Operand: 2.5
Value: 2.5
 |
+-------------+----------+-------------------------------------------------------------------+
...
| case        | test     | message                                                            |
+-------------+----------+--------------------------------------------------------------------+
| table-users | equals.2 | [equals.2] test (not_equals) is success. 
Operand: 2.5
Value: 3.5
 |
+-------------+----------+--------------------------------------------------------------------+
