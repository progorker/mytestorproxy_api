...
procedure mytestorproxy.api_testor_same (
...
$) set @v_test_id = -1; set @v_suite_id = 1; set @v_case_id = 11; call mytestorproxy.api_testor_same( '8003c6c90940e847a8e01897b4a93e4d', @v_test_id, @v_suite_id, @v_case_id, 'same.1', 'Hello world!', 'Hello world!' ); select @v_test_id, @v_suite_id, @v_case_id;
...
$) set @v_test_id = -1; set @v_suite_id = 1; set @v_case_id = 11; call mytestorproxy.api_testor_same( '8003c6c90940e847a8e01897b4a93e4d', @v_test_id, @v_suite_id, @v_case_id, 'same.2', 'Hello world!', 'Hello worldABC!' ); select @v_test_id, @v_suite_id, @v_case_id;
...
| case        | test   | message                                                                        |
+-------------+--------+--------------------------------------------------------------------------------+
| table-users | same.2 | [same.2] test (same) is failed. 
Operand: Hello world!
...
| case        | test   | message                                                                      |
+-------------+--------+------------------------------------------------------------------------------+
| table-users | same.1 | [same.1] test (same) is success. 
Operand: Hello world!
Value: Hello world!
 |
+-------------+--------+------------------------------------------------------------------------------+
