...
procedure mytestorproxy.api_testor_e_functions (
...
$) set @v_names = '_'; call mytestorproxy.api_testor_e_functions( 'mytestor', '', @v_names ); select @v_names;
...
| @v_names                                    |
+---------------------------------------------+
| api_testor_has_right , api_testor_is_online |
+---------------------------------------------+
