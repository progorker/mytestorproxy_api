...
procedure mytestorproxy.api_testor_not_true (
...
$) set @v_test_id = -1; set @v_suite_id = 1; set @v_case_id = 3; call mytestorproxy.api_testor_not_true( '8003c6c90940e847a8e01897b4a93e4d', @v_test_id, @v_suite_id, @v_case_id, 'greater.1', 2 > 1 ); select @v_test_id, @v_suite_id, @v_case_id;
...
$) set @v_test_id = -1; set @v_suite_id = 1; set @v_case_id = 3; call mytestorproxy.api_testor_not_true( '8003c6c90940e847a8e01897b4a93e4d', @v_test_id, @v_suite_id, @v_case_id, 'greater.2', 2 <= 1 ); select @v_test_id, @v_suite_id, @v_case_id;
...
| case        | test      | message                                                               |
+-------------+-----------+-----------------------------------------------------------------------+
| table-users | greater.1 | [greater.1] test (not_true) is failed. 
Condition: 1
Expected: false
 |
+-------------+-----------+-----------------------------------------------------------------------+
...
| case        | test      | message                                                                |
+-------------+-----------+------------------------------------------------------------------------+
| table-users | greater.2 | [greater.2] test (not_true) is success. 
Condition: 0
Expected: false
 |
+-------------+-----------+------------------------------------------------------------------------+
